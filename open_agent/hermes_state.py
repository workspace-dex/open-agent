...
# Inline sanitize_context (pulled from agent/memory_manager.py)
...
def _get_config_dir():
    """Get open-agent config dir."""
    from pathlib import Path
    return Path.home() / ".config" / "open-agent"


DEFAULT_DB_PATH = _get_config_dir() / "state.db"
